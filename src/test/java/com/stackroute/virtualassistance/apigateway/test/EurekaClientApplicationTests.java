package com.stackroute.virtualassistance.apigateway.test;
...
import com.stackroute.virtualassistance.apigateway.ApiGatewayApplication;
...
import static org.assertj.core.api.BDDAssertions.then;
 ...
 public class EurekaClientApplicationTests {
     ...
     public void shouldRegisterClientInEurekaServer() throws InterruptedException {
         ...
         then(response.getBody()).contains("Up and Running");
     }
